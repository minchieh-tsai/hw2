...
from P2Dataset2 import P2Dataset
...
if __name__ == '__main__':
    ...
    root_train = r"../../hw2_data/p2_data/train"
    root_val = r"../../hw2_data/p2_data/validation"
    ...
    device = torch.device(("cuda:" + device_no) if torch.cuda.is_available() else "cpu")
